...
def ArgSelector():
    ...
    print(" ")
    print("This script is intended to work on ALL Oceania Ship classes")
    print("Ensure excel files are in the same folder as PriceChanging.py")
...
def O_Class_Change(Info):
    ...
    # If type is "F" or "P", update prices in Pricing Grids for the respective tier
        ...
        try:  
            ...
            print(f"...Column {column} needs attention...")
...
def Price_Changes(ArgInfo):
    ...
    print(f"Pricing update completed for {Ship}")
    print(" ")
